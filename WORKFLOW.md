...
> 147 unit tests + 88 integration tests (235 total, 100% pass).
> Testcontainers optimizado: 1 contenedor/session (antes 88), tiempo de integración ~20s (antes ~20 min).
> `make lint` limpio. Version 0.4.0. Lista para F5.
